...
function summarizeOrder() {
  ...
  <div class="item-image">
    <img src="./assets/stolsoverdrag.jpeg" alt="Stolsöverdrag" style="width:60px; height:auto; margin:4px 0;">
  </div>
  ...
  <div class="item-image">
    <img src="./assets/stolsrosett.jpeg" alt="Stolsrosett" style="width:60px; height:auto; margin:4px 0;">
  </div>
  <div>
...
<div class="quantity-control">
  ...
  <div class="item-image">
    <img src="./assets/namnskylt.jpeg" alt="Namnskylt" style="width:60px; height:auto; margin:4px 0;">
  </div>
  ...
  <div>
    ...
    <div class="quantity-control">
      ...
      <div class="item-image">
        <img src="./assets/servetter.jpeg" alt="Servetter" style="width:60px; height:auto; margin:4px 0;">
      </div>
    ...
    <div class="quantity-control">
      ...
      <div class="item-image">
    <img src="./assets/duk.jpeg" alt="duk" style="width:60px; height:auto; margin:4px 0;">
  </div>
      <div>
  ...
  <!-- Bilden på stolsöverdrag -->
  <div class="item-image">
    <img src="./assets/ljusslingastor.jpeg" alt="ljusslingastor" style="width:60px; height:auto; margin:4px 0;">
  </div>
  <div>
...
<!-- Bilden på stolsöverdrag -->
  <div class="item-image">
    <img src="./assets/ljusslingaliten.jpeg" alt="ljusslingaliten" style="width:60px; height:auto; margin:4px 0;">
  </div>
  <div>
...
<!-- Bilden på stolsöverdrag -->
  <div class="item-image">
    <img src="./assets/rislampa.jpeg" alt="rislampa" style="width:60px; height:auto; margin:4px 0;">
  </div>
  <div>
...
<!-- Bilden på stolsöverdrag -->
  <div class="item-image">
    <img src="./assets/draperingstyg.jpeg" alt="draperingstyg" style="width:60px; height:auto; margin:4px 0;">
  </div>
  <div>
  ...
  <small><span data-i18n="dims_drapery">Dimensioner 75 cm x 800 cm</span></small>
    ...
    <button type="button" id="printSheetBtn" class="primary" data-i18n="print">Skriv ut</button>
<button type="button" id="downloadSheetBtn" data-i18n="download_sheet">Hämta kalkylark</button>
<button type="button"
        id="cancelBtn"
        data-i18n="cancel"
        data-target="#summaryBox">
  Avbryt
</button>
...
function getSummaryDataFromDOM() {
  // ⬇️ NYTT: välj rätt rot – modal först, annars legacy-boxen
  const root =
  ...
  root.querySelectorAll('.quantity-control').forEach(q => {
    ...
    if (/stolsöverdrag/i.test(name) && !dims) dims = 'Stolsöverdrag';
...
// Lägg det här längst ner i bestallning.js
window.summarizeOrder = summarizeOrder; // gör funktionen anropbar även om du vill ha inline-fallback

(function bindSammanstall() {
  const onClick = (e) => {
    const btn = e.target.closest('#sumButtonMobile');
    if (!btn) return;
    if (e.cancelable) e.preventDefault(); // bara om det går
    summarizeOrder();
  };

  // En enda bind; default = passive:false
  document.addEventListener('click', onClick);

  // Behöver du verkligen re-binda vid BFCache?
  // Ofta bevaras lyssnare ändå. Om du vill vara säker:
  window.addEventListener('pageshow', (ev) => {
    if (ev.persisted) {
      document.removeEventListener('click', onClick);
      document.addEventListener('click', onClick); // också utan passive:true
    }
  });
})();
