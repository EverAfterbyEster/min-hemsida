...
terms_3_html: "Ritverktyget sparar dina uppgifter lokalt i din webbläsare (localStorage) för att du ska kunna fortsätta där du slutade. Du kan när som helst exportera gästlista/bordsplanering som en .json-fil till din dator och importera den igen senare. Vi tar inte emot och lagrar inte kopior av dina listor eller filer på våra servrar.", 
terms_4_title: "4. Integritet",
terms_4_html: "Vi samlar inte in personuppgifter från innehållet du skriver i ritverktyget (t.ex. namn i gästlista). Allt du skriver stannar lokalt hos dig och används bara för att generera förhandsgranskning och filer (t.ex. .json eller .docx) i din webbläsare. Vi använder Simple Analytics enbart för aggregerad besöksstatistik utan att identifiera enskilda användare. Webbplatsen hostas på GitHub Pages, som kan föra tekniska serverloggar.",
